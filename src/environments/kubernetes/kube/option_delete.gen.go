...
var deleteOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--filename", Alias: "-f", Description: "Filename, directory, or URL to files containing the resource to delete."},
	...
	prompt.Suggest{Text: "--output", Alias: "-o", Description: "Output mode. Use \"-o name\" for shorter output (resource/name)."},
	...
	prompt.Suggest{Text: "--selector", Alias: "-l", Description: "Selector (label query) to filter on, not including uninitialized ones."},
