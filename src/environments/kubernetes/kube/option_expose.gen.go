...
var exposeOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--filename", Alias: "-f", Description: "Filename, directory, or URL to files identifying the resource to expose a service"},
	...
	prompt.Suggest{Text: "--labels", Alias: "-l", Description: "Labels to apply to the service created by this call."},
