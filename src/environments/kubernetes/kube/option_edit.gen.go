...
var editOptions = []prompt.Suggest{
	prompt.Suggest{Text: "--filename", Alias: "-f", Description: "Filename, directory, or URL to files to use to edit the resource"},
	...
	prompt.Suggest{Text: "--output", Alias: "-o", Description: "Output format. One of: yaml|json."},
