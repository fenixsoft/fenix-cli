...
var getOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--label-columns", Alias: "-L", Description: "Accepts a comma separated list of labels that are going to be presented as columns. Names are case-sensitive. You can also use multiple flag options like -L label1 -L label2..."},
	...
	prompt.Suggest{Text: "--watch", Alias: "-w", Description: "After listing/getting the requested object, watch for changes. Uninitialized objects are excluded if no object name is provided."},
