...
var replaceOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--filename", Alias: "", Description: "Filename, directory, or URL to files to use to replace the resource."},
	...
	prompt.Suggest{Text: "--output", Alias: "", Description: "Output mode. Use \"-o name\" for shorter output (resource/name)."},
	...
	prompt.Suggest{Text: "--recursive", Alias: "", Description: "Process the directory used in -f, --filename recursively. Useful when you want to manage related manifests organized within the same directory."},
