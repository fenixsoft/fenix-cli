...
var runOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--labels", Alias: "-l", Description: "Comma separated labels to apply to the pod(s). Will override previous values."},
	...
	prompt.Suggest{Text: "--replicas", Alias: "-r", Description: "Number of replicas to create for this container. Default is 1."},
	...
	prompt.Suggest{Text: "--stdin", Alias: "-i", Description: "Keep stdin open on the container(s) in the pod, even if nothing is attached."},
	...
	prompt.Suggest{Text: "--tty", Alias: "-t", Description: "Allocated a TTY for each container in the pod."},
}
