...
var rollingUpdateOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--filename", Alias: "", Description: "Filename or URL to file to use to create the new replication controller."},
	...
	prompt.Suggest{Text: "--output", Alias: "", Description: "Output format. One of: json|yaml|wide|name|custom-columns=...|custom-columns-file=...|go-template=...|go-template-file=...|jsonpath=...|jsonpath-file=... See custom columns [http://kubernetes.io/docs/user-guide/kubectl-overview/#custom-columns], golang template [http://golang.org/pkg/text/template/#pkg-overview] and jsonpath template [http://kubernetes.io/docs/user-guide/jsonpath]."},
	...
	prompt.Suggest{Text: "--show-all", Alias: "", Description: "When printing, show all resources (default show all pods including terminated one.)"},
